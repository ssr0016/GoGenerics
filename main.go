...
//you’ll add two functions that each add together the values of a map and return the total.
...
// SumInsOrFloats sums the values of map m. IT supports both int64 anf float64
// ast types for map values
